    ...
    if (isTelegramMessage) {
        if (text === res_text.l)
            sendMessage(
                res,
                id,
                (await c.client.profile(msg)) + res_text.onL,
                menu,
            );
            ...
            sendMessage(
                res,
                id,
                (await c.client.profile(msg)) + res_text.onM,
                profile,
            );
            ...
            sendMessage(
                res,
                id,
                (await c.appointment.booked(msg)) + res_text.onDedit,
                profile,
            );
            ...
            sendMessage(
                res,
                id,
                (await c.appointment.booked(msg)) + res_text.onDelete,
                profile,
            );
        ...
        // listener for commands
            ...
            sendMessage(
                res,
                id,
                await c.appointment.changeBarber(id, text),
                menu,
            );
            ...
            sendMessage(
                res,
                id,
                await c.appointment.changeService(id, text),
                menu,
            );
            ...
            sendMessage(
                res,
                id,
                await c.appointment.changeDate(id, text),
                menu,
            );
        ...
        // listener for start message
            ...
            sendMessage(
                res,
                id,
                'Hello, ' + first_name + '. Can i help you?',
                menu,
            );
        }
        sendMessage(res, id, res_text.onHelp, menu);
